...
export const EcamAbnormalSensedAta313233: { [n: number]: AbnormalProcedure } = {
  ...
  320900001: {
    // A380 FCOM PRO-ABN-ECAM-10-32 L/G LDG WITH ABNORM NOSE L/G
    title: '\x1b<4m\x1b4mL/G\x1bm LDG WITH ABNORM NOSE L/G',
    sensed: false,
    items: [
      { name: 'CABIN CREW', sensed: false, labelNotCompleted: 'ADVISE', labelCompleted: 'ADVISED' },
      { name: 'ATC', sensed: false, labelNotCompleted: 'NOTIFY', labelCompleted: 'NOTIFIED' },
      { name: 'LDG LIMITED TO MAX LDG WEIGHT', sensed: false },
      { name: 'GW DECREASE RQRD', sensed: false, condition: true },
      { name: 'JETTISON ARM', sensed: false, labelNotCompleted: 'ON', level: 1 },
      { name: 'JETTISON ACTIVE', sensed: false, labelNotCompleted: 'ON', level: 1 },
      { name: 'OXYGEN CREW SUPPLY', sensed: false, labelNotCompleted: 'OFF' },
      { name: 'CG AFT SHIFT (50 PAX = 2% CG)', sensed: false, labelNotCompleted: 'CONSIDER' },
      { name: 'DISREGARD NORM APPR & LDG C/Ls', sensed: false },
      { name: 'SIGNS', sensed: true, labelNotCompleted: 'ON' },
      { name: 'CABIN & CKPT (LOOSE EQPT)', sensed: false, labelNotCompleted: 'SECURE', labelCompleted: 'SECURED' },
      { name: 'LDG DIST AFFECTED', sensed: false },
      { name: 'FOR APPROACH :', sensed: true, style: ChecklistLineStyle.CenteredSubHeadline },
      { name: 'ECAM STS', sensed: false, labelNotCompleted: 'CHECK', level: 1 },
      { name: 'BARO REF', sensed: false, labelNotCompleted: 'SET', level: 1 },
      { name: 'MINIMA', sensed: false, labelNotCompleted: 'SET', level: 1 },
      { name: 'AUTO BRK : DO NOT ARM', sensed: false, level: 1 },
      { name: 'L/G GRVTY', sensed: false, labelNotCompleted: 'CHECK DOWN', level: 1 },
      { name: 'L/G LEVER', sensed: true, labelNotCompleted: 'CHECK DOWN', level: 1 },
      { name: 'JETTISON ACTIVE', sensed: false, labelNotCompleted: 'OFF', level: 1 },
      { name: 'JETTISON ARM', sensed: false, labelNotCompleted: 'OFF', level: 1 },
      { name: 'TRIM TK FEED', sensed: false, labelNotCompleted: 'ISOL', level: 1 },
      { name: 'CABIN REPORT', sensed: false, labelNotCompleted: 'OBTAIN', labelCompleted: 'OBTAINED', level: 1 },
      { name: 'EMER EXIT LT', sensed: false, labelNotCompleted: 'ON', level: 1 },
      { name: 'COMMERCIAL 1+2', sensed: false, labelNotCompleted: 'OFF', level: 1 },
      { name: 'A/THR', sensed: false, labelNotCompleted: 'AS RQRD', level: 1 },
      { name: 'FLAPS', sensed: false, labelNotCompleted: 'LDG', level: 1 },
      { name: 'GND SPLRs', sensed: true, labelNotCompleted: 'ARM', level: 1 },
      { name: 'BEFORE LANDING :', sensed: true, style: ChecklistLineStyle.CenteredSubHeadline },
      { name: 'RAM AIR', sensed: true, labelNotCompleted: 'ON', level: 1 },
      { name: 'REVERSERS : DO NOT USE', sensed: false, level: 1 },
      { name: 'BRACE FOR IMPACT', sensed: false, labelNotCompleted: 'ORDER', labelCompleted: 'ORDERED', level: 1 },
      { name: 'BEFORE NOSE IMPACT :', sensed: true, style: ChecklistLineStyle.CenteredSubHeadline },
      ...
      { name: 'ALL AGENTS (ENG & APU)', sensed: false, labelNotCompleted: 'AS RQRD', level: 1 },
      ...
      { name: 'EVAC NOT RQRD', sensed: false, condition: true },
      { name: 'CABIN CREW', sensed: false, labelNotCompleted: 'ADVISE', labelCompleted: 'ADVISED', level: 1 },
    ],
  },
  320900002: {
    // A380 FCOM PRO-ABN-ECAM-10-32 L/G LDG WITH 2 ABNORM L/Gs ON SAME SIDE
    ...
    items: [
      ...
      { name: 'BARO REF', sensed: false, labelNotCompleted: 'SET', level: 1 },
      { name: 'MINIMA', sensed: false, labelNotCompleted: 'SET', level: 1 },
      { name: '[MFD SURV] GPWS', sensed: true, labelNotCompleted: 'OFF', level: 1 },
      { name: 'AUTO BRK : DO NOT ARM', sensed: false, level: 1 },
      { name: 'L/G GRVTY', sensed: false, labelNotCompleted: 'CHECK DOWN', level: 1 },
      { name: 'L/G LEVER', sensed: true, labelNotCompleted: 'CHECK DOWN', level: 1 },
      { name: 'JETTISON ACTIVE', sensed: false, labelNotCompleted: 'OFF', level: 1 },
      ...
      { name: 'GND SPLRs', sensed: true, labelNotCompleted: 'ARM', level: 1 },
      { name: 'BEFORE LANDING :', sensed: true, style: ChecklistLineStyle.CenteredSubHeadline },
      { name: 'REVERSER : DO NOT USE', sensed: false, level: 1 },
      { name: 'BRACE FOR IMPACT', sensed: false, labelNotCompleted: 'ORDER', labelCompleted: 'ORDERED', level: 1 },
      { name: 'AT TOUCHDOWN :', sensed: true, style: ChecklistLineStyle.CenteredSubHeadline },
      { name: 'ENG 1 + 4 MASTERS', sensed: true, labelNotCompleted: 'OFF', level: 1 },
      { name: 'BEFORE NACELLE IMPACT :', sensed: true, style: ChecklistLineStyle.CenteredSubHeadline },
      { name: 'LEFT L/G AFFECTED', sensed: false, condition: true, level: 1 },
      { name: 'ENG 2 MASTER', sensed: true, labelNotCompleted: 'OFF', level: 2 },
      { name: 'ENG 3 MASTER', sensed: true, labelNotCompleted: 'OFF', level: 2 },
      { name: 'RIGHT L/G AFFECTED', sensed: false, condition: true, level: 1 },
      { name: 'ENG 3 MASTER', sensed: true, labelNotCompleted: 'OFF', level: 2 },
      { name: 'ENG 2 MASTER', sensed: true, labelNotCompleted: 'OFF', level: 2 },
      { name: 'WHEN AIRCRAFT STOPPED :', sensed: true, style: ChecklistLineStyle.CenteredSubHeadline },
      { name: 'PARK BRK', sensed: true, labelNotCompleted: 'ON', level: 1 },
  ...
  320900003: {
    // A380 FCOM PRO-ABN-ECAM-10-32 L/G LDG WITH 1 ABNORM WING OR BODY L/G
  ...
  320900004: {
    // A380 FCOM PRO-ABN-ECAM-10-32 L/G LDG WITH 2 ABNORM BODY L/Gs
    ...
    items: [
      ...
      { name: 'JETTISON ARM', sensed: false, labelNotCompleted: 'ON', level: 1 },
      { name: 'JETTISON ACTIVE', sensed: false, labelNotCompleted: 'ON', level: 1 },
      { name: 'CG > 37.5%', sensed: false, condition: true },
      { name: 'TRIM TK XFR', sensed: false, labelNotCompleted: 'FWD', level: 1 },
      { name: 'OUTER TK XFR', sensed: false, labelNotCompleted: 'AS RQRD', level: 1 },
      { name: 'CG FWD SHIFT (50 PAX = 2% CG)', sensed: false, labelNotCompleted: 'CONSIDER', level: 1 },
      { name: 'LDG DIST AFFECTED', sensed: false },
    ],
  },
  320900005: {
    // A380 FCOM PRO-ABN-ECAM-10-32 L/G LDG WITH 2 ABNORM WING L/Gs
