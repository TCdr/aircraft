...
class Pushback_A32NX : public Pushback {
  ...
  // ~10 km/h max, matching typical real-world pushback speed with the aircraft attached
  // (real tugs can transit faster, but not while towing).
  static constexpr FLOAT64 SPEED_FACTOR      = 9.1;  // ft/sec for "VELOCITY BODY Z" (also max speed)
